...
public class postDataFragment extends Fragment {
    ...
    private static final String TAG = postDataFragment.class.getSimpleName();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        buttonShout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                session = new SessionManager(postDataFragment.this.getContext());
                ...
                StringRequest strReqPost = new StringRequest(Request.Method.POST,
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (!error) {
                                Toast.makeText(postDataFragment.this.getContext(),
                            ...
                            // JSON error
                            e.printStackTrace();
                            Toast.makeText(postDataFragment.this.getContext(), "Json error: " + e.getMessage(), Toast.LENGTH_LONG).show();
                        }
